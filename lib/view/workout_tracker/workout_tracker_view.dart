...
class WorkoutTrackerView extends StatefulWidget {
  ...
  const WorkoutTrackerView({super.key, required this.userEmail});
                ...
                children: [
                  ...
                  ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return InkWell(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context) =>  WorkoutDetailView( dObj: wObj, userEmail: widget.userEmail) ));
                          },
