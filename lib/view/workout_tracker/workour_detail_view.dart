...
class WorkoutDetailView extends StatefulWidget {
  ...
  const WorkoutDetailView({super.key, required this.dObj, required this.userEmail});
                  ...
                  child: Column(
                    children: [
                      ...
                      IconTitleNextRow(
                          ...
                          onPressed: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => WorkoutScheduleView(userEmail: widget.userEmail) )  );
                          }),
                      SizedBox(
