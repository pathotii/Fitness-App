import '../../common_widget/onboard_page.dart';
...
class _OnBoardingViewState extends State<OnBoardingView> {
  ...
  List pageArr = [
    ...
    },
    {
      ...
      "subtitle":
          "Let's be Physically Fit, to achive yours goals, it hurts only temporarily, if you give up now you will be in pain forever",
    ...
    },
    {
      ...
      "image": "assets/img/onboard_4.png"
    },
  ];
                ...
                Container(
                  ...
                  child: IconButton(icon: Icon( Icons.navigate_next, color: TColor.white, ), onPressed: (){
                      ...
                      if(selectPage < 3) {
                        ...
                        Navigator.push(context, MaterialPageRoute(builder: (context) => const SignUpView(userEmail: '',) ));
                      }
